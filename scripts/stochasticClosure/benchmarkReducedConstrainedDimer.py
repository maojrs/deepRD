...
import pickle
import deepRD
from deepRD.diffusionIntegrators import langevinNoiseSamplerDimerConstrained1DGlobal
...
foldername = 'dimer1DGlobal/boxsize' + str(bsize) + '/benchmarkReduced_' + conditionedOn + '_' + str(nbins) + 'bins'
...
binnedDataFilename = localDataDirectory + 'dimer1DGlobal/boxsize' + str(bsize) + '/binnedData/' + conditionedOn + 'BinnedData_' + str(nbins) + 'bins.pickle'
