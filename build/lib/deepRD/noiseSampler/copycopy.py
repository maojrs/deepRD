...
class cvaeSampler(nn.Module):
    ...
    def __init__(self, latentDims, loadPretrained, conditionedOn, systemType, hidden_dims=None, batch_norm=False, dropout_rate=0, norm_params=(0,1,0,1), sampling_width=1):
        super().__init__()
