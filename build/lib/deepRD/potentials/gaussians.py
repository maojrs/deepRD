...
class gaussians(externalPotential):
    '''
    Potential class for two attractive gaussians potential of the form:
    -scale * (exp( -((x-mu1)*(x-mu1)/(2*sigma1^2)))/( (2pi)^(3/2) sigma1**3) +
    +         exp( -((x-mu2)*(x-mu2)/(2*sigma2^2)))/( (2pi)^(3/2) sigma2**3)).
